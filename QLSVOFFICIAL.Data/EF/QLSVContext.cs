...
using QLSVOFFICIAL.Data.Configurations;

namespace QLSVOFFICIAL.Data.EF
{
    public partial class QLSVContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public QLSVContext()
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new AbsenceFormConfiguration());
